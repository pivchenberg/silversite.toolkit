<?
namespace Silversite\Toolkit\IblockPropertiesOrm;
use Silversite\Toolkit;
use Bitrix\Main;
...
class ElementTable extends Entity\DataManager
{
    ...
    public static function createEntity($iblockId, $parameters = array())
    {
        ...
        // build entity code
        $classCode = $classCode."class {$entityName} extends Silversite\\Toolkit\\IblockPropertiesOrm\\ElementTable {";
        $classCodeEnd = '}'.$classCodeEnd;
