...
use Silversite\Toolkit\VarDumper\Dumper\CliDumper;
...
%A  options: []
  ...
  "obj" => Silversite\Toolkit\VarDumper\Tests\Fixture\DumbFoo {#%d
    +foo: "foo"
    +"bar": "bar"
  }
  "closure" => Closure {{$r}
    class: "Silversite\Toolkit\VarDumper\Tests\CliDumperTest"
    this: Silversite\Toolkit\VarDumper\Tests\CliDumperTest {{$r} …}
    parameters: {
      \$a: {}
      &\$b: {
        typeHint: "PDO"
  ...
  8 => &1 null
  "sobj" => Silversite\Toolkit\VarDumper\Tests\Fixture\DumbFoo {#%d}
  "snobj" => &3 {#%d}
  "snobj2" => {#%d}
  "file" => "{$var['file']}"
  b"bin-key-é" => ""
...
%Awrapper_type: "PHP"
  ...
  uri: "php://memory"
%Aoptions: []
  ⚠: Silversite\Toolkit\VarDumper\Exception\ThrowingCasterException {{$r}
