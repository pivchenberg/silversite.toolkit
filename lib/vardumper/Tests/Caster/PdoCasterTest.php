...
use Silversite\Toolkit\VarDumper\Caster\PdoCaster;
use Silversite\Toolkit\VarDumper\Cloner\Stub;
...
class PdoCasterTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testCastPdo()
    {
        ...
        $this->assertInstanceOf('Silversite\Toolkit\VarDumper\Caster\EnumStub', $cast["\0~\0attributes"]);

        $attr = $cast["\0~\0attributes"] = $cast["\0~\0attributes"]->value;
        $this->assertInstanceOf('Silversite\Toolkit\VarDumper\Caster\ConstStub', $attr['CASE']);
